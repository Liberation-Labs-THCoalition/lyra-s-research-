...
magnitude) but behaviorally inert. The methodology follows exactly what
Anthropic uses for J-space ablation experiments, which \emph{do}
produce behavioral effects in their production models. Yet on an 8B
