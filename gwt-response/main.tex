...
Throughout, we report our full empirical record, including the
canonical list of ten audited kills (\S\ref{sec:bodycount}), and engage
...
size; cross-scale universality of workspace structure is an open
question their paper raises but does not address. Our geometric
...
did. Table~\ref{tab:bodycount} presents the canonical audited kill list
from the Nexus audit (June 2026), not a curated selection.
