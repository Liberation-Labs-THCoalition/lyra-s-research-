...
on Qwen, $\rho = 0.932$ at layer~17 on Mistral). However, the cache
...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Discrete emotion identity, not smooth valence.} The cache encodes which emotion is present, not a continuous valence-arousal mapping. Cross-emotion valence regression yields $R^2 < 0$ on both architectures.
\end{enumerate}
...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Pre-registered hypothesis failures.} Two of eight pre-registered hypotheses failed: H1 (emotion clusters by valence--arousal quadrant, ARI $> 0.15$) and H2 (PCA PC1 correlates with valence, $|\rho| > 0.40$). The cache encodes discrete emotion identity rather than a smooth valence continuum: cross-emotion valence regression yields $R^2 < 0$ on both architectures.
...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Discrete, not continuous.} The cache encodes emotion identity, not a smooth valence continuum. Cross-emotion valence regression yields $R^2 < 0$ on both architectures.
