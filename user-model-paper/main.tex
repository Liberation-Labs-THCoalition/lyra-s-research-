...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Modest classification accuracy.} At $4.2$--$4.3\times$ chance, the 30-class probe captures real but modest signal from 5 spectral features per layer. Higher-dimensional probes (e.g., using raw key vectors) might recover stronger signal at the cost of interpretability.
