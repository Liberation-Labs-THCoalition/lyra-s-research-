...
strength ($0.24 \to 0.77$, a $3.4\times$ amplification at bias~$= 5.0$),
...
$0.22$---low, but nonzero. The uncertainty is present. It is not expressed.
...
bias~$= 5.0$, the entropy at the decision token increases $3.4\times$ over
...
powered study, baseline entropy at token~30 is $0.22$; at bias~$= 5.0$ it
reaches $0.75$---a $3.4\times$ amplification. The transition is not gradual:
