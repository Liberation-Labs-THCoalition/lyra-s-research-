...
\noindent\textbf{Compute requirements}: 30,000 trials $\times$ $\sim$15s/trial $\approx$ 125 GPU-hours. Feasible on remote GPU cluster (3$\times$ RTX 3090) within the 4-week experimental window.
