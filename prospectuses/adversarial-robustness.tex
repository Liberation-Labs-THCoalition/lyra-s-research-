...
\begin{itemize}
  \item \textbf{Black-box}: Remote GPU cluster + existing pipeline. 1--2 days.
  \item \textbf{Gray-box}: Remote GPU cluster + modified detection pipeline.
    2--3 days.
  \item \textbf{White-box}: Requires fine-tuning infrastructure.
    Remote GPU cluster can fine-tune 7B models (LoRA). 27B requires H100 or
