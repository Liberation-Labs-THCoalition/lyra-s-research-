...
Expected compute: 4--6 hours on remote GPU cluster (Qwen2.5-7B already loaded). Analysis identical to English pipeline.
...
\begin{itemize}
  \item \textbf{Compute}: Remote GPU cluster (3$\times$RTX 3090). Qwen2.5-7B already loaded. Estimated 4--6 hours for 100 Chinese prompts $\times$ 3 conditions (replication, code-switching English-topic, code-switching Chinese-topic). Phase 4 mixed-language: additional 2 hours.
