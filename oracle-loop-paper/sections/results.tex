...
The norm feature's standalone AUROC (0.915) exceeding the 5-feature
ensemble (0.758) reflects dilution by four near-chance features; this
paradox motivated the shift to individual-feature analysis on the full
cache, where spectral gap provides a clean signal without ensemble
dependency. Note: these ablation results are directionally informative
but not conclusive at $n = 7$ confabulations (bootstrap CI lower bound
0.573 approaches chance).
